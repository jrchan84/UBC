...
namespace filler
{
        ...
        // animation vorCustomDFS(PNG& img, double density, double fadeFactor, int frameFreq);
        ...
        // animation vorCustomBFS(PNG& img, double density, double fadeFactor, int frameFreq);
...
vector<center> randSample(PNG& img, double density);
    ...
    //HELPER FUNCTIONS FOR VOR
    template <template <class T> class OrderingStructure>
    bool isOver(vector<OrderingStructure<point>> & structure);
    void sendFrame(animation & ai, PNG & img, int frame, int frameFreq);

    bool inBounds(point p, PNG & img);

    void process(point p, PNG & newImg, colorPicker & fillColor, int & frame, animation & animation, int frameFreq);

    void addNeighbors(point p, PNG & newImg, vector<vector<bool>> & processed, OrderingStructure<point> & queue);
}
